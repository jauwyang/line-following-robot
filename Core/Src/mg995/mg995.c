...
/**
 * User-defined constants (from experimentation)
 */
#define ROBOT_ANGLE_OPEN	(uint8_t) 130
...
/**
 * Convenience functions for opening and closing the claw, using the user-defined constants
 */
void mg995_open_claw(void) {
	mg995_move_to(ROBOT_ANGLE_OPEN);
}

void mg995_close_claw(void) {
	mg995_move_to(ROBOT_ANGLE_CLOSE);
}
